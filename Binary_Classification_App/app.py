...
def main():
    ...
    @st.cache_data(persist=True)  #Function decorator to memoize function executions(Documentations)
    def load_data():
    ...
    if classifier == 'Random Forest':
        ...
        #bootstrap = st.sidebar.radio("Bootstrap samples when building trees", ('True'), key='bootstrap')
